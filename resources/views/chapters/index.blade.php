            ...
            <div class="col-12 mt-4 mb-4">
                <div class="row justify-content-center">
                    <div style="word-wrap:break-word; width: 60%">
                        <h1 class="text-white">{{$matkul->name}}</h1>
                    </div>
                </div>
            </div>
            <div class="col-12 mt-4 mb-4">
                        ...
                        <div class="col-8 mb-4 mb-sm-0">
                            <div class="list" id="list-tab" role="tablist">
                                ...
                                <button 
                                    ...
                                    style="border:none;width: 100%;height: 40px;text-align: left;" class="list-group-item btn btn-outline-info active show" data-toggle="list">Tambah Bab</button>
                            </div>
                                                ...
                                                <div class="form-validation">
                                                    <div class="form-group">
                                                        <div class="row col-md-12">
                                                            <input class="form-control input-rounded" id="name" name="name" placeholder="Masukkan modul" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row col-md-12">
            ...
            <form class="form-valide" action="{{ route('specializations.courses.chapters.store', [$matkul->specialization->id, $matkul->id])}}" method="POST" novalidate="novalidate">
                ...
                <div class="modal-body">
                    <div class="form-validation">
                        <div class="form-group">
                            <div class="row col-md-12">
                                <input class="form-control input-rounded" id="name" name="name" placeholder="Masukkan bab" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row col-md-12">
